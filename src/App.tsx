...
function App() {
  return (
    <div className="w-screen h-screen overflow-auto">
      <div className="w-full min-h-full flex flex-col bg-primary p-12 gap-12">
        <div className="w-full h-64 rounded-md overflow-hidden relative">
          ...
          <img src={Logo} alt="logo" className="absolute bottom-8 left-8 w-48" />
        </div>
        <div className="flex flex-col gap-6">
          ...
          <TypographyP className="text-primary-foreground opacity-80">
          ...
          <TypographyP className="text-primary-foreground opacity-80">Just one click. Every time.</TypographyP>
          <div className="text-primary-foreground opacity-80">
            ...
            <ul className="list-disc list-inside font-lausanne font-[200] text-[18px] leading-[1.5]">
